...
app.config["SQLALCHEMY_DATABASE_URI"] = "postgresql://localhost/catieoHW5"
## Provided:
...
class UpdatePriorityForm(FlaskForm):
    new_priority = IntegerField("What is the new priority of this todo list item?", validators=[Required()])
    submit = SubmitField("Update")
